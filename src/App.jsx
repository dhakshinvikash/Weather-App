...
import { convertTemperature, getHumidityValue, getVisibilityValue, getWindDirection } from './Helper.jsx';
import { HumidityIcon, SunriseIcon, SunsetIcon, VisibilityIcon, WindIcon } from './Icons.jsx';
...
const App = () => {
  ...
  const API_key = '06228bd09b385a8b74c7b5d13d6eb6bb'
        ...
        w-full border border-white/30 relative z-10'>
          ...
          {!weather ? (
                ...
                <div className='absolute top-12 left-0 right-0 bg-transparent shadow-md rounded  z-10'>
                  {suggestions.map((s) => (
                    ...
                    onClick={() => fetchWeatherData(`
                      ...
                      )} className='block hover:bg-blue-700 bg-transparent px-4 py-2 text-sm text-left
            ...
            <div className='mt-6 text-sm'>
              <p><strong>Fells Like:</strong> {convertTemperature(weather.main.feels_like, unit)} &deg;{unit}</p>
